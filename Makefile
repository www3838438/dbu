...
download_firefox_addons:
	...
	# https://addons.mozilla.org/en-US/firefox/addon/lightbeam/ [security] [webextension]
	# https://addons.mozilla.org/en-US/firefox/addon/mind-the-time/ [tools] [webextension]
	# https://addons.mozilla.org/en-US/firefox/addon/new-tab-tools/ [ui] [webextension]
	# https://addons.mozilla.org/en-US/firefox/addon/noscript/ [security] [webextension]
	# https://addons.mozilla.org/en-US/firefox/addon/reddit-enhancement-suite/ [tools] [webextension]
	# https://addons.mozilla.org/en-US/firefox/addon/rsstube/ [webextension] [ui]
	# https://addons.mozilla.org/en-US/firefox/addon/terms-of-service-didnt-read/ [security] [webextension]
	# https://addons.mozilla.org/en-US/firefox/addon/tree-style-tab/ [webextension] [ui]
	# https://addons.mozilla.org/en-US/firefox/addon/turn-off-the-lights/ [ui] [webextension]
	# https://addons.mozilla.org/en-US/firefox/addon/umatrix/ [security] [webextension]
	# https://addons.mozilla.org/en-US/firefox/addon/update-scanner/ [tools] [webextension]
	# https://addons.mozilla.org/en-us/firefox/addon/copy-as-markdown/ [tools] [webextension]
	# e10s
	# https://addons.mozilla.org/en-US/firefox/addon/password-reuse-visualizer/ [security] [e10s]
	# https://addons.mozilla.org/en-US/firefox/addon/random-agent-spoofer/ [security] [e10s]
	# https://addons.mozilla.org/en-US/firefox/addon/requestpolicy-continued/ [security] [e10s]
	# https://addons.mozilla.org/en-US/firefox/addon/new-tab-bookmarks/ [ui] [e10s]
	# https://addons.mozilla.org/en-US/firefox/addon/password-exporter/ [tools] [e10s]
	# https://addons.mozilla.org/en-US/firefox/addon/watch-with-mpv/ [tools] [e10s]
	...
	# https://addons.mozilla.org/en-US/firefox/addon/about-addons-memory/ [dev] [e10s]
	# https://addons.mozilla.org/en-us/firefox/addon/auto-refresh-for-twitter/ [tools] [e10s]
	# https://addons.mozilla.org/en-US/firefox/addon/bookmark-deduplicator/ [tools] [e10s]
	# https://addons.mozilla.org/en-US/firefox/addon/bookrect/ [tools] [e10s]
	# https://addons.mozilla.org/en-US/firefox/addon/toggle-js/ [e10s] [ui]
	# https://addons.mozilla.org/en-US/firefox/addon/tab-badge/ [e10s] [ui]
	# https://addons.mozilla.org/en-US/firefox/addon/tab-scope/ [e10s] [ui]
	# https://addons.mozilla.org/en-us/firefox/addon/ssleuth/ [security] [e10s]
	# https://addons.mozilla.org/en-US/firefox/addon/user-agent-switcher/ [dev] [e10s]
	# https://addons.mozilla.org/en-US/firefox/addon/open-livestreamer/ [tools] [e10s]
	# Legacy
	# https://addons.mozilla.org/en-US/firefox/addon/simple-mail/ [tools] [legacy]
	# https://addons.mozilla.org/en-US/firefox/addon/certificate-patrol/ [security] [legacy]
	# https://addons.mozilla.org/en-us/firefox/addon/http-nowhere/ [security] [legacy]
	# https://addons.mozilla.org/en-US/firefox/addon/markdown-viewer/ [tools] [legacy]
	# https://addons.mozilla.org/en-US/firefox/addon/mozilla-archive-format/ [tools] [legacy]
	# https://addons.mozilla.org/en-US/firefox/addon/perspectives/ [security] [legacy]
	# https://addons.mozilla.org/en-US/firefox/addon/print-edit/ [tools] [legacy]
	# https://addons.mozilla.org/en-US/firefox/addon/yesscript/ [security] [legacy]
	# https://addons.mozilla.org/en-US/firefox/addon/bookmark-autohider/ [ui] [legacy]
	# https://addons.mozilla.org/en-us/firefox/addon/unloadtab/ [dev] [legacy]
	# https://addons.mozilla.org/en-US/firefox/addon/tamper-data/ [legacy] [dev]
