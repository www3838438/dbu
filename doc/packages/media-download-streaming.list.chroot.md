...
__downloader of videos from YouTube and other sites__
...
southpark.cc.com, southpark.cc.com:espa?ol, southpark.de, southpark.nl,
...
![](https://screenshots.debian.net/thumbnail/youtube-dlg/)
...
* [youtube-dl](https://packages.debian.org/jessie/youtube-dl) - downloader of videos from YouTube and other sites
* [livestreamer](https://packages.debian.org/jessie/livestreamer) - CLI that pipes video streams to video players
...
<sub> [get-flash-videos](https://packages.debian.org/jessie/get-flash-videos) [mps-youtube](https://packages.debian.org/jessie/mps-youtube) [cclive](https://packages.debian.org/jessie/cclive) [gnome-twitch](https://packages.debian.org/jessie/gnome-twitch) [libav-tools](https://packages.debian.org/jessie/libav-tools) [#jessie](https://packages.debian.org/jessie/#jessie) [without](https://packages.debian.org/jessie/without) [backports](https://packages.debian.org/jessie/backports) [minitube](https://packages.debian.org/jessie/minitube)  </sub>
